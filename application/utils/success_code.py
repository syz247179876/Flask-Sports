...
# 邮件验证失败
EMAIL_VERIFICATION_ERROR = 2007

# 电话验证成功
PHONE_VERIFICATION_SUCCESS = 2008

# 电话验证失败
PHONE_VERIFICATION_ERROR = 2009

# 找回密码验证成功
FIND_PASSWORD_VERIFICATION_SUCCESS = 2010

# 找回密码验证失败
FIND_PASSWORD_VERIFICATION_ERROR = 2011

# 修改密码验证成功
MODIFY_PASSWORD_VERIFICATION_SUCCESS = 2012

# 修改密码验证失败
MODIFY_PASSWORD_VERIFICATION_ERROR = 2013

# 用户已经存在
USER_EXISTS = 2014

# 用户不存在
USER_NOT_EXISTS = 2015
